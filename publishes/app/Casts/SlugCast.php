...
class SlugCast implements CastsAttributes
{
    ...
    public function set($model, string $key, $value, array $attributes)
    {
        ...
        $value = $this->convertToUnicode($value);
        $value = $this->replaceSpecialChar($value," ");
        $value = \Illuminate\Support\Str::limit($value, 140);
        return \Illuminate\Support\Str::slug($value);
    }

   protected function replaceNCR($str)
    {
   ...
   protected function convertToUnicode($string)
    ...
    protected function replaceSpecialChar($string, $replace = "")
    {
        $search = array('/', '\\', ':', ';', '!', '@', '#', '$', '%', '^', '*', '(', ')', '_', '+', '=', '|', '{', '}', '[', ']', '"', "'", '<', '>', ',', '?', '~', '`', '&', '.');
