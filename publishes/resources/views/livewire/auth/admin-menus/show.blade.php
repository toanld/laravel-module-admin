<div class="w-full min-h-screen">
    ...
    <x-lma.box.show listing="{{route('admin.auth.admin-menus')}}" edit="{{route('admin.auth.admin-menus.edit',['record_id'=>$data->id])}}">
        <table class="table max-w-screen-lg border">
            ...
            <tr><th class=" text-right border-r">Parent:</th><td >{{optional($data->parent)->name}}</td></tr>
            ...
            <tr><th class=" text-right border-r">Roles:</th><td ><x-lma.label.tags :params="$data->roles->pluck('title')"></x-lma.label.tags></td></tr>
